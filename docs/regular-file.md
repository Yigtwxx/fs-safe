...
```ts
import { statRegularFile } from "@openclaw/fs-safe";
...
```ts
import { readRegularFile } from "@openclaw/fs-safe";
...
```ts
import { appendRegularFile } from "@openclaw/fs-safe";
...
```ts
import { resolveRegularFileAppendFlags } from "@openclaw/fs-safe";
