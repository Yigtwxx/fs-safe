...
.brand .mark{display:flex;align-items:center;justify-content:center;flex:0 0 30px;width:30px;height:30px;border-radius:8px;background:var(--ink)}
.brand .mark svg{width:18px;height:18px;display:block;color:var(--shield)}
...
.home-hero h1{font-size:3.1rem;line-height:1.04;letter-spacing:-.01em;margin:0 0 .35em;font-weight:700;color:var(--ink)}
.home-hero .lede{font-size:1.15rem;line-height:1.55;color:var(--text);margin:0 0 1.2em;max-width:62ch}
...
.home-services{display:flex;flex-wrap:wrap;gap:6px;margin:8px 0 18px}
...
.doc h1{font-size:2.5rem;line-height:1.08;letter-spacing:-.005em;margin:0 0 .4em;font-weight:700;color:var(--ink)}
body:not(.home) .doc>h1:first-child{display:none}
.doc h2{font-size:1.4rem;line-height:1.2;margin:2em 0 .5em;font-weight:600;letter-spacing:0;color:var(--ink);position:relative}
.doc h3{font-size:1.08rem;margin:1.7em 0 .35em;position:relative;font-weight:600;color:var(--ink);letter-spacing:0}
.doc h4{font-size:.96rem;margin:1.4em 0 .25em;color:var(--ink);position:relative;font-weight:600}
...
export function brandMarkSvg() {
  return `<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M12 2 L21 5.5 L21 12.2 C21 17.4 17.2 21.4 12 22 C6.8 21.4 3 17.4 3 12.2 L3 5.5 Z" fill="currentColor"/>
  <path d="M7.5 12.2 L10.7 15.4 L16.5 9.6" stroke="#0f172a" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`;
}

export function faviconSvg() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img" aria-label="fs-safe">
<rect width="64" height="64" rx="12" fill="#0f172a"/>
<path d="M32 10 L52 18 L52 33 C52 44 44 52 32 55 C20 52 12 44 12 33 L12 18 Z" fill="#10b981"/>
<path d="M21 33 L29 41 L44 24" fill="none" stroke="#0f172a" stroke-width="4.4" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`;
}
