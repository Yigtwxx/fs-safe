...
const repoBase = "https://github.com/openclaw/fs-safe";
const repoEditBase = `${repoBase}/edit/main/docs`;
const cname = readCname();
const siteBase = cname ? `https://${cname}` : "";

const productName = "fs-safe";
const productTagline = "Safe filesystem primitives for Node.js";
...
const sections = [
  ["Start", ["index.md", "install.md", "quickstart.md", "security-model.md"]],
  ["Root API", ["root.md", "reading.md", "writing.md", "path-scope.md"]],
  ["Atomic & temp", ["atomic.md", "json.md", "temp.md", "archive.md"]],
  ["Specialized", ["secret-file.md", "regular-file.md", "private-file-store.md", "sidecar-lock.md", "pinned-open.md", "local-roots.md"]],
...
function homeHero(page) {
  ...
  return `<header class="home-hero">
        ...
        <div class="home-cta">
          ...
          <div class="home-install" aria-label="Install with pnpm">
            <span class="prompt" aria-hidden="true">$</span>
            <code>${escapeHtml(installCmd)}</code>
          </div>
        </div>
        <div class="home-services" aria-label="Primitives">
          ${primitives.map((s) => `<span>${escapeHtml(s)}</span>`).join("")}
        </div>
    ...
    <aside class="sidebar">
      <div class="sidebar-head">
        <a class="brand" href="${hrefToOutRel("index.html", page.outRel)}" aria-label="${productName} docs home">
          ...
          <span><strong>${escapeHtml(productName)}</strong><small>Safe filesystem primitives</small></span>
        </a>
        ${themeToggleHtml()}
      </div>
      <label class="search"><span>Search</span><input id="doc-search" type="search" placeholder="root, json, archive…"></label>
